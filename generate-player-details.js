...
.hero h1{font-family:var(--font-sans);font-weight:800;font-size:clamp(44px,5.5vw,80px);line-height:.9;letter-spacing:-.04em;margin:0}
...
.prow{display:grid;grid-template-columns:140px 1fr 140px;gap:0;padding:10px 0;border-bottom:1px solid var(--rule-soft);align-items:center;color:inherit}
...
<body>
    ...
    <div class="frame">
      <div class="masthead-inner">
        <div class="wordmark">No<span class="slash">/</span>Spoiler Cricket
          <span class="sub">Player Sheet · 2026</span>
        </div>
        <div class="mast-meta">
  ...
  <main class="frame">
    ...
    <section class="hero">
      ...
      <div>
        <div class="tag">
          <span>${flag} ${htmlEscape(player.nationality || '')}</span>
      ...
      <aside>
        ...
        <div class="stat"><span class="k">Nation</span><span class="v sm">${flag} ${htmlEscape(player.nationality || '')}</span></div>
      </aside>
    </section>
    ...
    <section class="section">
      ...
      <h2>Bio</h2>
      <div class="bio">
        <div class="s"><div class="k">Nationality</div><div class="v sm">${flag} ${htmlEscape(player.nationality || 'Unknown')}</div></div>
    ...
    <footer class="foot">
      <div class="foot-row">
        ...
        <span>§ Player Sheet · ${htmlEscape(display)}</span>
